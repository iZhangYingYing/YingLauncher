...
{
    /// <summary>
    /// YingConsole.xaml 的交互逻辑
    /// </summary>
    public partial class YingConsole : Window
    {
        ...
        */
        ...
        public YingConsole()
        {
            ...
            MouseLeftButtonDown += (y, yy) => DragMove();
        ...
        */
        ...
        private Func<ListView, YingLogType, String, long, DateTime, int> ysendMessage = (ylist, ytype, ymessage, yspend, ytime) =>
        {
            ...
            if (yymessage.Length > 1)
            {
                ...
                foreach (String yy in yymessage)
                {
                    ...
                    yrun.Foreground = new SolidColorBrush(yycolor);
        ...
        private Action<ListView, int, YingLogType, String, long, DateTime> YYAction = (ylist, yline, ytype, ymessage, yspend, ytime) =>
        {
        ...
        public int sendYMessage(String ymessage = "", YingLogType ytype = YingLogType.YInfo, long yspend = 0, DateTime ytime = new DateTime())
        {
            ...
            //ytime = DateTime.Now;
            return (int)this.Dispatcher.Invoke(this.ysendMessage, _forgeList, ytype, ymessage, yspend, ytime);
        }

        public YingConsole setYMessage(int yline, String ymessage = "", YingLogType ytype = YingLogType.YInfo, long yspend = 0, DateTime ytime = new DateTime())
        {
            this.Dispatcher.Invoke(this.YYAction, _forgeList, ytype, yline, ymessage, yspend, ytime);
            return this;
        }
