namespace KMCCC.Modules.JVersion
{
    ...
    public class JLibDownloadInfo
    {
        [JsonPropertyName("artifact")]
        public JFileInfo Artifact { get; set; }

        [JsonPropertyName("classifiers")]
        public Dictionary<string, JFileInfo> Classifiers { get; set; }
    }
    ...
    public class JLibrary
	{
        ...
        [JsonPropertyName("downloads")]
        public JLibDownloadInfo Downloads { get; set; }
    }
