...
namespace Ying.Pages
{
    public partial class ModPage : Page
    {
        ...
        public ModPage()
        {
            ...
            if (YingConfig.YArgs.HasAnyVersion && YingConfig.YArgs.IsVersionSplit)
            {
                _modsDir = $"{YingApp.YCore.GameRootPath}\\versions\\{YingConfig.YArgs.SelectedVersion.Id}\\mods\\";
            }
            else
            {
                _modsDir = $"{YingApp.YCore.GameRootPath}\\mods\\";
            }
